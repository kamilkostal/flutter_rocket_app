...
class FlightDetailMock extends StatefulWidget {
  static const String routeName = '/flight-detail';

  @override
  State<FlightDetailMock> createState() => _FlightDetailMockState();
}

class _FlightDetailMockState extends State<FlightDetailMock>{
  @override
  void initState() {
    super.initState();
  }
